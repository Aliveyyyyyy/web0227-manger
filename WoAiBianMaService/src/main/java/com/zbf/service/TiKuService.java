...
public class TiKuService {
     ...
     * @param redisTemplate
     */
    public void deleteTiKuById(Map<String, Object> paramsJsonMap, RedisTemplate redisTemplate) {

        tiKuMapper.deleteTiKuById(paramsJsonMap);

        redisTemplate.opsForHash().delete(MyRedisKey.TIKU.getKey(),paramsJsonMap.get("id").toString(),paramsJsonMap);
    }
}
